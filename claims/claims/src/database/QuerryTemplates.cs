...
namespace claims.src.database
{
    public static class QuerryTemplates
    {
        ...
        public static readonly string INSERT_CITY = "INSERT INTO CITIES (NAME, MAYOR, GUID, TIMESTAMPCREATED, debtbalance, perm, plotgroups, prisons, alliance, defaultplotcost, hostiles, comrades, invmsg, opencity, fee, criminals, istechnical, bonusplots, extrachunksbought, citycolor, templerespawnpoints, ranks, eventlog, warcooldowns, grievances, overlord, vassals, vassalsince, naps, warjustifications, emblem, tier, neutral, neutraldroppedat) VALUES (@name, @mayor, @guid, @timestampcreated, @debtbalance,@perm,@plotgroups,@prisons, @alliance, @defaultplotcost, @hostiles, @comrades, @invmsg, @opencity, @fee, @criminals, @istechnical, @bonusplots, @extrachunksbought, @citycolor, @templerespawnpoints, @ranks, @eventlog, @warcooldowns, @grievances, @overlord, @vassals, @vassalsince, @naps, @warjustifications, @emblem, @tier, @neutral, @neutraldroppedat)";
        public static readonly string UPDATE_CITY = "UPDATE CITIES SET NAME=@name, MAYOR=@mayor, GUID=@guid, timestampcreated=@timestampcreated, debtbalance=@debtbalance, perm=@perm, plotgroups=@plotgroups, prisons=@prisons, alliance=@alliance, defaultplotcost=@defaultplotcost, hostiles=@hostiles, comrades=@comrades, invmsg=@invmsg, opencity=@opencity, fee=@fee, criminals=@criminals, istechnical=@istechnical, bonusplots=@bonusplots, extrachunksbought=@extrachunksbought, citycolor=@citycolor, templerespawnpoints=@templerespawnpoints, ranks=@ranks, eventlog=@eventlog, warcooldowns=@warcooldowns, grievances=@grievances, overlord=@overlord, vassals=@vassals, vassalsince=@vassalsince, naps=@naps, warjustifications=@warjustifications, emblem=@emblem, tier=@tier, neutral=@neutral, neutraldroppedat=@neutraldroppedat WHERE guid=@guid";
        ...
        public static readonly string INSERT_ALLIANCE = "INSERT INTO ALLIANCIES (name, guid,maincity,cities,hostiles,comrades,alliancefee,neutral, neutraldroppedat, prefix, timestampcreated, pendingunionbreaks, unionbreakcooldowns, emblem) VALUES (@name, @guid, @maincity, @cities, @hostiles ,@comrades, @alliancefee ,@neutral, @neutraldroppedat, @prefix, @timestampcreated, @pendingunionbreaks, @unionbreakcooldowns, @emblem)";
        public static readonly string UPDATE_ALLIANCE = "UPDATE ALLIANCIES SET name=@name, guid=@guid, maincity=@maincity, cities=@cities, hostiles=@hostiles, comrades=@comrades ,alliancefee=@alliancefee ,neutral=@neutral, neutraldroppedat=@neutraldroppedat, prefix=@prefix , timestampcreated=@timestampcreated, pendingunionbreaks=@pendingunionbreaks, unionbreakcooldowns=@unionbreakcooldowns, emblem=@emblem where guid=@guid";
        ...
        //LAND AUCTION
        public static readonly string DELETE_AUCTION = "DELETE FROM AUCTIONS WHERE guid=@guid";
        public static readonly string INSERT_AUCTION = "INSERT INTO AUCTIONS (guid, kind, x, z, lotcity, sellercity, startprice, minincrement, buyoutprice, currentbid, currentbidder, startedat, endsat, audience, targetcity, reason, state) VALUES (@guid, @kind, @x, @z, @lotcity, @sellercity, @startprice, @minincrement, @buyoutprice, @currentbid, @currentbidder, @startedat, @endsat, @audience, @targetcity, @reason, @state)";
        public static readonly string UPDATE_AUCTION = "UPDATE AUCTIONS SET kind=@kind, x=@x, z=@z, lotcity=@lotcity, sellercity=@sellercity, startprice=@startprice, minincrement=@minincrement, buyoutprice=@buyoutprice, currentbid=@currentbid, currentbidder=@currentbidder, startedat=@startedat, endsat=@endsat, audience=@audience, targetcity=@targetcity, reason=@reason, state=@state where guid=@guid";

        public static readonly string DELETE_AUCTIONBID = "DELETE FROM AUCTIONBIDS WHERE guid=@guid";
        public static readonly string INSERT_AUCTIONBID = "INSERT INTO AUCTIONBIDS (guid, auctionguid, cityguid, cityname, amount, timestamp) VALUES (@guid, @auctionguid, @cityguid, @cityname, @amount, @timestamp)";
        public static readonly string UPDATE_AUCTIONBID = "UPDATE AUCTIONBIDS SET auctionguid=@auctionguid, cityguid=@cityguid, cityname=@cityname, amount=@amount, timestamp=@timestamp where guid=@guid";
        ...
        public static readonly IReadOnlyDictionary<string, (string Insert, string Update, string Delete)> ByTable =
            new Dictionary<string, (string Insert, string Update, string Delete)>
            {
                ...
                { "AUCTIONS",        (INSERT_AUCTION,        UPDATE_AUCTION,        DELETE_AUCTION) },
                { "AUCTIONBIDS",     (INSERT_AUCTIONBID,     UPDATE_AUCTIONBID,     DELETE_AUCTIONBID) },
            };
    }
}
